			...
			<section className='max-w-7xl mx-auto px-6 md:px-4 flex md:flex-row flex-col items-center justify-between mt-30'>
				<div className='md:text-left text-center flex flex-col gap-6'>
					...
					<div className='flex md:justify-start justify-center gap-3 mt-10'>
						<a
							href='#contact'
							className='text-sm md:text-base bg-cyan-700 text-white font-bold py-3 px-8 rounded transition duration-300 dark:bg-black hover:-translate-y-1'
						>
							Contact Me
						</a>
						<a
							...
							className='text-sm md:text-base bg-transparent border border-cyan-700 hover:-translate-y-1 text-white font-bold py-3 px-8 rounded transition duration-300 dark:text-black dark:border-black'
						>
							Download CV
						</a>
					</div>
